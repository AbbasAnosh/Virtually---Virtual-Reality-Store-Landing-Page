      ...
      <div className="container mx-auto h-full">
        <div className="h-full bg-explore bg-no-repeat bg-cover p-14 flex flex-col items-start justify-center">
          ...
          >
            ...
            consequatur harum minima atque officia accusamus sit optio possimus.
            Aperiam, qui. Possimus reprehenderit nam natus quis dolores
            aspernatur deserunt blanditiis mollitia.
          </p>
          <form
